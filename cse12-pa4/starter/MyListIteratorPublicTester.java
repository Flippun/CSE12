...
public class MyListIteratorPublicTester {
    ...
    public void testAddRules() {
        ...
        listLen3Iter.add("CSE 12");
        
        assertEquals("Valid add left", "CSE 12",
                listLen3Iter.left.getElement());
        assertEquals("Valid add right", listLen3.tail,
                listLen3Iter.right);
        assertEquals("Index change after add", 1, listLen3Iter.idx);
        assertFalse("Cannot remove immediately after add",
                listLen3Iter.canRemoveOrSet);
        assertEquals("", listLen3Iter.left.prev ,listLen3.head);
        assertEquals("", listLen3Iter.left.next ,listLen3.tail);
        assertEquals("", listLen3Iter.left ,listLen3.tail.prev);
        assertEquals("", listLen3Iter.left ,listLen3.head.next);
    }
    ...
    public void testAddRules2() {
        ...
        assertEquals("Valid add right", null,
                listLen2Iter.right.getElement());
        assertEquals("Valid add right", listLen2.tail,
                listLen2Iter.right);
        assertEquals("Index change after add", 3, listLen2Iter.idx);
        assertFalse("Cannot remove immediately after add",
                listLen2Iter.canRemoveOrSet);
    }
}
