...
public class PublicTester {
    ...
    public void testMinHeapGetParentIdx() {
        ...
        assertEquals("Parent index of 5", 2, MyMinHeap.getParentIdx(5));
    }
    ...
    public void testMinHeapGetLeftChildIdx() {
        ...
        assertEquals("Left child index of 5", 11, MyMinHeap.getLeftChildIdx(5));
    }
    ...
    public void testMinHeapGetRightChildIdx() {
        ...
        assertEquals("Right child index of 5",
                12, MyMinHeap.getRightChildIdx(5));
    }
    ...
    public void testMinHeapGetMinChildIdx() {
        MyMinHeap<Integer> heap = initMinHeap(Arrays.asList(5, 3, 1, 1, 1));
        assertEquals("Minimum child index of 0", 2, heap.getMinChildIdx(0));
        assertEquals("Minimum child index of 1", 3, heap.getMinChildIdx(1));
        assertEquals("Minimum child index of 2", -1, heap.getMinChildIdx(2));
        assertEquals("Heap after getting minimum child index should be unchanged.",
                Arrays.asList(5, 3, 1, 1, 1), heap.data);
    }
    ...
    public void testMinHeapPercolateUp() {
        ...
        MyMinHeap<Integer> heap2 = initMinHeap(Arrays.asList(5, 4, 3, 2, 1));
        heap2.percolateUp(4);
        assertEquals("Heap is properly updated after percolating up.",
                Arrays.asList(1, 5, 3, 2, 4), heap2.data);
    }
    ...
    public void testMinHeapDeleteIndex() {
        ...
        assertEquals("Heap is properly updated after deleting index.",
                Arrays.asList('A', 'D', 'D', 'G', 'Z', 'X'), heap.data);
    }

    @Test
    public void testMinHeapDeleteIndex2() {
        MyMinHeap<Character> heap = initMinHeap(Arrays.asList('A'));
        heap.deleteIndex(0);
        assertEquals("Heap is properly updated after deleting index.",
    ...
    @Test
    public void testMinHeapDeleteIndex3() {
        MyMinHeap<Character> heap =
                initMinHeap(Arrays.asList('A', 'D', 'D', 'E', 'Z'));
        heap.deleteIndex(4);
        assertEquals("Heap is properly updated after deleting index.",
                Arrays.asList('A', 'D', 'D', 'E'), heap.data);
    }
